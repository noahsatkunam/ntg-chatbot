...
export default {
  ...
  build: {
    command: 'sh -c "npm --prefix frontend ci --ignore-scripts --no-audit --fund=false && npm --prefix frontend run build:lovable"',
  ...
  dev: {
    command: 'sh -c "npm --prefix frontend ci --ignore-scripts --no-audit --fund=false && npm --prefix frontend run dev"',
    port: 5173
  },
